(function () {
    ...
    console.log("snake.js loaded", {
        snakeContainerExists: !!snakeContainer,
        secretBtnExists: !!secretBtn
    });

    if (!snakeContainer || !secretBtn) {
        console.error("Snake init error: #snake-container or #secret-btn not found");
        return;
    }
    ...
    function toggleSnakeInternal() {
        console.log("toggleSnake called", { snakeVisible });
    ...
    secretBtn.addEventListener("click", toggleSnakeInternal);
